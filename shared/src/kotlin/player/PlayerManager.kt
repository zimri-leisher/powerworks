...
object PlayerManager : PacketHandler, PlayerEventListener {
    ...
    private val startingInventory = ResourceList(ItemType.ALL.map { it to it.maxStack }.toMap())//resourceListOf(BlockItemType.ITEM_PIPE to 10, BlockItemType.MINER to 2, BlockItemType.SMELTER to 2, BlockItemType.CHEST_SMALL to 1,
