...
data class Chunk(
    ...
    fun addResourceNode(r: ResourceNode) = data.resourceNodes.elementAt(r.resourceCategory.ordinal).add(r)

    fun removeResourceNode(r: ResourceNode) = data.resourceNodes.elementAt(r.resourceCategory.ordinal).remove(r)
