...
class GuiPool<W>(val newGuiFor: (any: Any?) -> W, val poolSize: Int = 5) where W : Gui, W : PoolableGui {
    ...
    /**
     * Opens a [Gui] window that corresponds to the given [obj].
     ...
     * [PoolableGui.displayBlock] (eligibility determined by [PoolableGui.canDisplayBlock]), or create a new one and delete an
