 ...
 */
fun ResourceContainerGroup.give(list: ResourceList, from: ResourceNodeOld? = null, checkIfAble: Boolean = true): Boolean {
    var ret = true
    for ((r, q) in list) {
 ...
 */
fun ResourceContainerGroup.give(resource: ResourceType, quantity: Int, from: ResourceNodeOld? = null, checkIfAble: Boolean = true): Boolean {
 ...
 */
fun ResourceContainerGroup.take(list: ResourceList, to: ResourceNodeOld? = null, checkIfAble: Boolean = true): Boolean {
    var ret = true
    for ((r, q) in list) {
 ...
 */
fun ResourceContainerGroup.take(resource: ResourceType, quantity: Int, to: ResourceNodeOld? = null, checkIfAble: Boolean = true): Boolean {
    for (container in this) {
