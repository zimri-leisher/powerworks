...
abstract class ResourceContainer(
    ...
    fun canAdd(resource: ResourceType, quantity: Int = 1) = isRightType(resource) && spaceFor(resource, quantity)

    fun canRemove(resource: ResourceType, quantity: Int = 1) = isRightType(resource) && contains(resource, quantity)
