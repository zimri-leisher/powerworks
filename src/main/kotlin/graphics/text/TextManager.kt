...
object TextManager {
    ...
    fun parseTags(text: String): TaggedText {
        val tags = mutableMapOf<Int, TextTag>()
        ...
        while(i <= text.lastIndex) {
            ...
            if(char == TaggedText.TAG_BEGIN_CHAR) {
                ...
                val tagType = TextTagType.values().first { it.identifier == tagName || it.aliases.any { it == tagName } }
                ...
                tags.put(i - offset, TextTag(tagArgument, tagType))
