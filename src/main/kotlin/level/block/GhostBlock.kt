...
class GhostBlock(type: BlockType<*>, xTile: Int, yTile: Int, rotation: Int) : Block(type, xTile, yTile, rotation) {
    ...
    override fun render() {
        ...
        Renderer.renderTextureKeepAspect(Image.Misc.ARROW, xPixel, yPixel, type.widthTiles shl 4, type.heightTiles shl 4, TextureRenderParams(rotation = 90 * rotation, alpha = 0.3f))
