...
class RenderParams(var scale: Float = 1.0f, var scaleWidth: Float = 1.0f, var scaleHeight: Float = 1.0f, var alpha: Float = 1.0f, var xPixelOffset: Int = 0, var yPixelOffset: Int = 0, var rotation: Int = 0, var renderToLevel: Boolean = false) {
