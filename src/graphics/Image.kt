...
object Images {
    ...
    val BLOCK_PLACEABLE = Image("/textures/level/block/placeable.png")
    val BLOCK_NOT_PLACEABLE = Image("/textures/level/block/not_placeable.png")
    val HOTBAR_SLOT = Image("/textures/screen/gui/hotbar_slot.png")
    val HOTBAR_SLOT_SELECTED = Image("/textures/screen/gui/hotbar_slot_selected.png")
    val CURSOR_DEFAULT = Image("/textures/screen/cursor/cursor_default.png")
    val CURSOR_LEFT_CLICK = Image("/textures/screen/cursor/cursor_left_click.png")
    val IRON_ORE_ITEM = Image("/textures/screen/item/iron_ore_raw.png")
    val CONVEYOR_BELT_ITEM = Image("/textures/screen/item/conveyor_belt.png")
    val IRON_INGOT = Image("/textures/screen/item/iron_ingot.png")
    val MAIN_MENU_LOGO = Image("/textures/misc/main_menu_logo.png")
    val GUI_DEFAULT_CORNER_TOP_RIGHT = Image("/textures/screen/gui/default/top_right_corner.png")
    val GUI_DEFAULT_CORNER_TOP_LEFT = Image("/textures/screen/gui/default/top_left_corner.png")
    val GUI_DEFAULT_CORNER_BOTTOM_RIGHT = Image("/textures/screen/gui/default/bottom_right_corner.png")
    val GUI_DEFAULT_CORNER_BOTTOM_LEFT = Image("/textures/screen/gui/default/bottom_left_corner.png")
    val GUI_DEFAULT_EDGE_TOP = Image("/textures/screen/gui/default/top_edge.png")
    val GUI_DEFAULT_EDGE_BOTTOM = Image("/textures/screen/gui/default/bottom_edge.png")
    val GUI_DEFAULT_EDGE_RIGHT = Image("/textures/screen/gui/default/right_edge.png")
    val GUI_DEFAULT_EDGE_LEFT = Image("/textures/screen/gui/default/left_edge.png")
    val GUI_DEFAULT_BACKGROUND = Image("/textures/screen/gui/default/background.png")
    val ITEM_SLOT = Image("/textures/screen/gui/item_slot.png")
    val ITEM_SLOT_HIGHLIGHT = Image("/textures/screen/gui/item_slot_highlight.png")
    val ITEM_SLOT_DISPLAY = Image("/textures/screen/gui/item_slot_display.png")
    val ITEM_SLOT_CLICK = Image("/textures/screen/gui/item_slot_click.png")
    val CHAT_BAR = Image(Utils.modify("/textures/screen/gui/chat_bar.png", ImageParams(scaleWidth = 180.0, scaleHeight = 10.0)))
    val ARROW = Image(Utils.modify("/textures/misc/arrow.png", ImageParams(alphaMultiplier = 50)))
    val VOID = Image(Color(0))
    val ORE_MINER = Image("/textures/level/block/machine/ore_miner.png")
    ...
    val GUI_DRAG_GRIP = Image("/textures/screen/gui/drag_grip.png")
    val GUI_SCROLL_BAR_TOP = Image("/textures/screen/gui/scroll_bar_top.png")
    val GUI_SCROLL_BAR_MIDDLE = Image("/textures/screen/gui/scroll_bar_middle.png")
    val GUI_SCROLL_BAR_BOTTOM = Image("/textures/screen/gui/scroll_bar_bottom.png")
    val GUI_SCROLL_BAR_UNHIGHLIGHT_TOP = Image("/textures/screen/gui/scroll_bar_unhighlight_top.png")
    val GUI_SCROLL_BAR_UNHIGHLIGHT_MIDDLE = Image("/textures/screen/gui/scroll_bar_unhighlight_mid.png")
    val GUI_SCROLL_BAR_UNHIGHLIGHT_BOTTOM = Image("/textures/screen/gui/scroll_bar_unhighlight_bottom.png")
    val GUI_SCROLL_BAR_HIGHLIGHT_TOP = Image("/textures/screen/gui/scroll_bar_highlight_top.png")
    val GUI_SCROLL_BAR_HIGHLIGHT_MIDDLE = Image("/textures/screen/gui/scroll_bar_highlight_mid.png")
    val GUI_SCROLL_BAR_HIGHLIGHT_BOTTOM = Image("/textures/screen/gui/scroll_bar_highlight_bottom.png")
    val GUI_SCROLL_BAR_CLICK_TOP = Image("/textures/screen/gui/scroll_bar_click_top.png")
    val GUI_SCROLL_BAR_CLICK_MIDDLE = Image("/textures/screen/gui/scroll_bar_click_mid.png")
    val GUI_SCROLL_BAR_CLICK_BOTTOM = Image("/textures/screen/gui/scroll_bar_click_bottom.png")
    val MAIN_MENU_BACKGROUND = Image(Color(0x5B5B5B))
    val MAIN_MENU_BUTTON_BOX = Image("/textures/screen/gui/main_menu.png")
    val OPTIONS_MENU_BACKGROUND = Image(Color(0x999999))
    val ESCAPE_MENU_BACKGROUND = Image("/textures/screen/gui/escape_menu_background.png")
}
